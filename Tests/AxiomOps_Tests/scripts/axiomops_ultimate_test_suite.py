...
This is the ULTIMATE test suite that includes:
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('axiomops_ultimate_test_suite.log'),
...
def main():
    ...
    parser = argparse.ArgumentParser(description="AxiomOps Ultimate Test Suite")
    ...
    logger.info(f"\n{'='*60}")
    logger.info(f"AxiomOps Ultimate Test Suite")
