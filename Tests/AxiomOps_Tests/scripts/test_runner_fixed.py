#!/usr/bin/env python3
"""
AxiomOps Test Runner - Fixed Version
====================
Run individual tests or the full suite.
Designed for vibe coders using Copilot Chat with 3B models.

Usage:
    python test_runner_fixed.py --test 1.1
    python test_runner_fixed.py --phase unit
    python test_runner_fixed.py --all
...
def check_environment():
    ...
    try:
        ...
        print("   Please start PostgreSQL server on localhost:5432")
        return False
...
def main():
    ...
    parser = argparse.ArgumentParser(description="AxiomOps Test Runner - Fixed Version")
